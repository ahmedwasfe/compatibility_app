  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            margin: EdgeInsetsDirectional.only(end: 13.r),
            child: Stack(
              children: [
                InkWell(
                  onTap: () {
        ...
        child: Column(
          ...
          children: [
                ...
                decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                          color: AppColors.lightBorder2, width: 0.w),
                      borderRadius: BorderRadius.circular(8).r,
                    ),
            ...
            Container(
              ...
              alignment: AlignmentDirectional.center,
              child: AppText.larg(text: 'aya'.tr,color: Colors.black,fontSize: 14.r),
            ),
            ...
            Container(
              ...
              child: ImageSlideshow(
                ...
                children: [
                  ...
                  //   height: double.infinity,
                  //   fit: BoxFit.cover,),
                  Image.asset('${Const.images}dlider_k.jpg',width: double.infinity,
                height: double.infinity,
                fit: BoxFit.cover,),
                  Image.asset('${Const.images}dlider_k.jpg',width: double.infinity,
                    height: double.infinity,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsetsDirectional.only(top: 10.r,end: 16.r,start: 16.r),
                    child: AppText.medium(text: 'intrections'.tr,fontSize: 14.h,fontWeight: FontWeight.w400),
                  ),

                  Container(
                      padding: EdgeInsetsDirectional.only(top: 40.r),
                      alignment: Alignment.center,
                      child: AppWidgets.CustomButton(text: 'app_evaluation'.tr, click:(){
                        AppHelper.showRatingapp(context);
                      },
                        height: 43.h,width: 180.w,radius: 6.r,
                      )),
                ],
              ),
            ),
               ...
               Row(
                 children: [
                  ...
                  Container(
                      padding: EdgeInsetsDirectional.only(top: 40.r),
                      alignment: Alignment.center,
                      child: AppWidgets.CustomButton(text: 'check_email'.tr, click:(){
                        Get.toNamed(Routes.check_email);
                      },
                        height: 47.h,width: 250.w,radius: 6.r,
                      )),
