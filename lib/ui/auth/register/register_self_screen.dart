...
class RegisterSelfScreen extends StatelessWidget {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      alignment: AlignmentDirectional.center,
                      padding: EdgeInsetsDirectional.only(top: 12.r,end: 12.r),
                      child: AppText.medium(
                          text: 'self',
                          fontSize: 16,
                    ...
                    Container(
                      margin: EdgeInsetsDirectional.only(top: 10.r,start: 12,end: 12),
                      width:320.r ,
                      height:
                      150.r,
                      alignment: AlignmentDirectional.center,
                                ...
                                decoration: InputDecoration(
                                    ...
                                    enabledBorder: OutlineInputBorder(
                                      borderSide: BorderSide(
                                          color:  AppColors.lightBorder, width: 0.w),
