...
class ProfialScreen extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  AppText.medium(text: 'personal_information'.tr,fontSize: 15.h,fontWeight: FontWeight.w600),
                  SizedBox(height: 2.h,),
                  AppText.medium(text: 'update_personal'.tr,fontSize: 12.h,fontWeight: FontWeight.w600,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      textInputAction: TextInputAction.go,
                      controller: controller.confrimPassworedController,
                      keyboardType: TextInputType.visiblePassword,
                      obscureText: controller.isVisiblePass,
                      obscuringCharacter: '•',
                      cursorColor: Colors.black,
                      ...
                      validator: (conformPassword) =>
                          AppHelper.validateConfirmPassword(conformPassword: conformPassword!, password: ''),
                    ),
            ...
            Container(
                ...
                child: AppWidgets.CustomButton(text: 'save'.tr, click:(){
                  AppHelper.showProfialSuccess(context);
