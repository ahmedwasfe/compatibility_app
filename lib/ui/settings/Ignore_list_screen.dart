import 'package:compatibility_app/controller/ignore_list_controller.dart';
...
class IgnoreListScreen extends StatelessWidget {
  final _controller = Get.put(IgnoreListController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: _controller.getUsersIgnore(),
        builder: (_, snapshot) {
            ...
            if(_controller.listUsers.isNotEmpty) {
                  ...
                  Expanded(
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) =>
                            buildUsersIgnors(_controller.listUsers[index]),
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    SvgPicture.asset('${Const.images}no_memebers_ignores.svg'),
                    AppText.medium(text: 'no_memebers_ignores')
                  ],
                ),
              );
            }
  ...
  Widget buildUsersIgnors(User user) {
    return Container(
      margin: EdgeInsetsDirectional.only(start: 16.r, end: 16.r, top: 10.r),
